<template>
    <div class="slide-enter-active" id="detailContainer">
        <Header title="影片详情">
        ...
        <div class="contentDetail" id="content">
            ...
            <div class="detail_player swiper-container" ref="detail_player">
                <ul class="swiper-wrapper">
                    <li :key="index" class="swiper-slide" v-for="(photo,index) in detailMovie.photos">
                        <div>
                            <img :src="photo | setWH('2000.2000')" alt="">
                        </div>
                    </li>
        ...
        mounted() {
            this.axios.get("/api/detailmovie?movieId=" + this.movieId).then((res) => {
                ...
                if (msg === 'ok') {
                    ...
                    console.log(this.detailMovie.photos);
                    this.$nextTick(() => {
